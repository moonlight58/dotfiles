...
Rectangle {
    ...
    FontLoader { id: pfNothing; source: "font/nothing_5_7.ttf" }
    FontLoader { id: pfDotNR; source: "font/arrow_nr.ttf" }
            ...
            Column {
                ...
                Rectangle {
                    ...
                    Row {
                        ...
                        Text {
                            text: "•"
                            font.family: pfNothing.source !== "" ? pfNothing.name : root.sansFont
                            font.pixelSize: 14 * s
